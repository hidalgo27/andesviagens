        ...
        <div class="header-menu-d clearfix">
            <div class="col">
                <div class="row justify-content-between">
                    <div class="col-7 col-sm-4 col-md-4 col-lg-3 col-xl-3 header-packages bg-light-t d-none d-sm-block">
                        {{--<div class="row">--}}
                                ...
                                <form id="d_form">
                                    {{csrf_field()}}
                                        ...
                                        <div class="p-2">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-1">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" id="d_name" placeholder="Nome Completo">
                                                    </div>
                                                    <div class="mb-1">
                                                        {{--<label for="inputEmail4" class="col-form-label"><sup class="text-danger">*</sup>Email</label>--}}
                                                        <input type="email" class="form-control form-control-sm" id="d_email" placeholder="Seu Email">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="">
                                                <div class="row">
                                                    <div class="col-6 col-sm-6 col-md-6 col-lg mb-1" data-toggle="buttons">
                                        ...
                                        <div class="alert alert-success alert-dismissible fade d-none" id="d_alert" role="alert">
                                            ...
                                            <strong>Muito obrigados</strong> por seu contato com ANDES VIAGENS.
                                        </div>

                                        <div class="col p-2">
                                            {{--<button type="submit" class="btn btn-lg btn-block btn-warning">Submit</button>--}}

                                            <button class="btn btn-block btn-warning" id="d_send" type="button" onclick="design()">Enviar
                                                <i class="fa fa-paper-plane" aria-hidden="true"></i>
                                            </button>
                                            <ul class="fa-ul pull-right d-none" id="loader2">
                                                <li><i class="fa-li fa fa-spinner fa-spin"></i> <i>Enviando...</i></li>
                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col mt-5 text-center d-none d-sm-block">
                                {{--<p class="h1 text-light">Display 4</p>--}}
                                <div class="row justify-content-center">
                                    <div class="col-8">
                                        <div class="row">
                                ...
                                <blockquote class="blockquote text-center mt-30vh">
                    ...
                    <div class="col-12 col-sm-5 col-md-5 col-lg-3 header-packages">
                        ...
                        <div class="col mt-5 text-center d-sm-none">
                            ...
                            <blockquote class="blockquote text-center">
                                ...
                                <a href="https://api.whatsapp.com/send?phone=51992051190" class="d-sm-none"><img src="{{asset('images/icons/whatsapp.png')}}" alt=""></a>
                                    ...
                                    <div class="card-footer text-muted">
                                        <div class="row">
                                            <div class="col-4 text-left">
                                                <img src="{{asset('images/card.png')}}" alt="" class="img-fluid">
                                            </div>
